import React, {Component, createContext, FC, useContext, useEffect} from 'react';
import './Tweet.css';
import './Avatar.css';
import './Author.css';
import './Time.css';
    ...
    return (
        <div className="tweet">
            ...
            <div className="content">
                <Author {...tweet.author} /> <Time time={tweet.timestamp}/>
                <div><Message message={tweet.message}/></div>
                <div>User Context: <Message message={user}/></div>
                <Buttons/>
            </div>
        </div>
    )
